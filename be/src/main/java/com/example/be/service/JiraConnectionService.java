...
public interface JiraConnectionService {
    ...
    Map<String, String> getAllTicketsForCurrentUserOAuth(UUID connectionId);

    JiraIssueDetailsResponse getTicketByIdUsingOAuth(UUID connectionId, String ticketKey);
